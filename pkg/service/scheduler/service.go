...
// FindTask returns task by prefix of ID or name if the prefix is unique.
func (s *Service) FindTask(ctx context.Context, pre string) (*Task, error) {
	s.logger.Debug(ctx, "FindTask", "prefix", pre)
